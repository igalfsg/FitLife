...
public class fitcalc extends Activity {
    protected EditText fcweight;
    protected EditText fcheight;
    protected TextView bmires;
    ...
    public void onRadioButtonClickw (View view)
    {
        boolean checked = ((RadioButton) view).isChecked();

        // Check which radio button was clicked
        switch(view.getId()) {
            case R.id.radio_kg_fit:
                if (checked) {
                    weightfactor = 1;
                    break;
                }
            case R.id.radio_lbs_fit:
                if (checked) {
        ...
        // Check which radio button was clicked
        switch(view.getId()) {
            case R.id.radio_cm_fit:
                if (checked) {
                    heightfactor = 1;
                    break;
                }
            case R.id.radio_inch_fit:
                if (checked) {
                    heightfactor = 2.54;
                    break;
                }
    ...
    public void imageClick(View view) {
        switch (view.getId()) {
            case R.id.calculate_bmi:
                ...
                if (this.getCurrentFocus() != null){
                    InputMethodManager inputManager =
                            (InputMethodManager) fitcalc.this.getSystemService(Context.INPUT_METHOD_SERVICE);
                ...
                break;
            case R.id.menu_hr:
                Intent takeUsertoschool = new Intent(fitcalc.this, hr.class);
            ...
            case R.id.menu_maxrep:
                Intent takemax = new Intent(fitcalc.this, max.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fitcalc);
        Intent intent = getIntent();
        karma = intent.getIntExtra("karma", 0);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        //initialaizations
        fcheight = (EditText)findViewById(R.id.heightfitcalc);
        fcweight = (EditText)findViewById(R.id.Weightfitcalc);
        bmires = (TextView)findViewById(R.id.bmi_result);
        /*rmrep = (EditText)findViewById(R.id.rmrepss);
        rmWeight = (EditText)findViewById(R.id.rmweightt);
        rmmaxcalc = (Button)findViewById(R.id.rmbutton);
        bmicalc = (Button)findViewById(R.id.calculate_bmi);
